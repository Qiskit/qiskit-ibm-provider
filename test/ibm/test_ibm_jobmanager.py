...
from qiskit_ibm.managed.ibm_job_manager import IBMJobManager
...
from qiskit_ibm.managed.exceptions import (
    IBMJobManagerJobNotFound, IBMManagedResultDataNotAvailable)
...
class TestIBMJobManager(IBMTestCase):
    """Tests for IBMJobManager."""
    ...
    def test_retrieve_job_set(self):
        ...
        for count, max_expr in sub_tests:
            with self.subTest(count=count):
                ...
                rjob_set = IBMJobManager().retrieve_job_set(
    ...
    def test_index_out_of_range(self):
        ...
        result_manager = job_set.results()
        with self.assertRaises(IBMJobManagerJobNotFound):
    ...
    def test_skipped_result(self):
        ...
        result_manager = job_set.results()
        with self.assertRaises(IBMManagedResultDataNotAvailable):
            result_manager.get_counts(1)
    ...
    def test_ibm_managed_results_signature(self):
