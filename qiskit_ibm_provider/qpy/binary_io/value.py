...
def dumps_value(obj, *, index_map=None):  # type: ignore[no-untyped-def]
...
def write_value(file_obj, obj, *, index_map=None):  # type: ignore[no-untyped-def]
...
def read_value(file_obj, version, vectors, *, clbits=(), cregs=None):  # type: ignore[no-untyped-def]
