...
integration-test-1:
	python -m unittest -v test/integration/test_ibm_qasm_simulator.py test/integration/test_backend.py test/integration/test_basic_server_paths.py \
  	...
  	test/integration/test_account_client.py test/integration/test_jupyter.py test/integration/test_proxies.py \
...
integration-test-3:
	python -m unittest -v test/integration/test_websocket_integration.py test/integration/test_ibm_job_attributes.py
