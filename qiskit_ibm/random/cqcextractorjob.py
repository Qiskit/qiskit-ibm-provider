...
class CQCExtractorJob:
    ...
    :meth:`~qiskit_ibm.random.CQCExtractor.run_async_ext1`,
    :meth:`~qiskit_ibm.random.CQCExtractor.run_async_ext2`, or
    :meth:`~qiskit_ibm.random.CQCExtractor.retrieve_job` method of the
    :class:`~qiskit_ibm.random.CQCExtractor` class.
    ...
    Note:
        ...
        :class:`~qiskit_ibm.api.exceptions.RequestsApiError`
